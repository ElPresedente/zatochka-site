...
<template>
  <Teleport to="body">
    <div
      class="fixed inset-0 bg-black/60 flex items-center justify-center z-[300] p-4"
      @click.self="emit('close')"
    >
      <div class="bg-white rounded-2xl p-6 lg:p-10 max-w-[440px] w-full text-center shadow-2xl">
